...
class NetworkTrainer(object):
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        ...
        # self.print_to_log_file("saving weight...")
        torch.save({
            'epoch': self.epoch + 1,
    ...
    def run_training(self):
        ...
        while self.epoch < self.max_num_epochs:
            ...
            self.print_to_log_file("Tr_L : %.4f" % self.all_tr_losses[-1])
            ...
            with torch.no_grad():
                ...
                self.print_to_log_file("Val_L : %.4f" % self.all_val_losses[-1])
                ...
                if self.also_val_in_tr_mode:
                    ...
                    self.print_to_log_file("Val_L (train=True): %.4f" % self.all_val_losses_tr_mode[-1])
            ...
            self.epoch += 1
            self.print_to_log_file("time: %f s" % (epoch_end_time - epoch_start_time))
            # print("")
